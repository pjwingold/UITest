...
import com.inteliment.pjwin.uitest.view.fragment.FragmentOne;
...
public class MainActivity extends BaseActivity {
    ...
    private void initViewPager() {
        ...
        adapter.addFragment(FragmentOne.newInstance(getString(R.string.view_fragment_1)));
        adapter.addFragment(FragmentOne.newInstance(getString(R.string.view_fragment_2)));
        adapter.addFragment(FragmentOne.newInstance(getString(R.string.view_fragment_3)));
        adapter.addFragment(FragmentOne.newInstance(getString(R.string.view_fragment_4)));
